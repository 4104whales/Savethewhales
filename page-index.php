...
<div class="container-fluid">
    ...
    <div class="pure-content">
      ...
      <div class="pure-g">
        <section class="pure-u-8-24 page-mid-title">
              <h2>
      ...
      <div class="pure-g">
        <section class="pure-u-8-24 new_stories" id="s1">
            <h2>
                Learn
            </h2>
        ...
        <section class="pure-u-8-24 new_stories" id="s2">
            <h2>
                Teach
            </h2>
        ...
        <section class="pure-u-8-24 new_stories" id="s3">
            <h2>
                Volunteer
            </h2>
